module.exports = function (app) {
  ...
  router.use('/login', function (req, res, next) {
    ...
    function getAuthGroupsAndOwnerIDs() {
      ...
      //Set up classes used to find OwnerIDs. Can be reused across app because only saved data is list of available
      //Auth Groups in system
      ...
      return updateAuthGroupsAndOwnerIDs.updateAuthGroups(user)
        ...
        //Now get all of the ownerIDs this user can see based on their auth group membership (if they are an admin)
    ...
    function updateDBonLogin() {
      ...
      //But usually finding Modified Only doesn't entail retrieving a lot of rows so for updating when logging in should get modified Only (dontRemoveGPOitems =true)
      ...
      //Only get the metadata because getting slash data is much slower, due to more data over the wire
      ...
      //For Admin, multiple user names will be run thus Admin download can not be done till all usernames in ownerIDs
      //are available
      //groupedTasks is a list of all tasks that must be free for this Admin until downloadGPOdata.download can be
      //executed
      var TaskReady = {};
