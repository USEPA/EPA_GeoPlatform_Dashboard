      ...
      async.forEachOf(authGroups, function(authGroup, key, done) {
          Q(self.ownerIDsCollection.findOne({authGroups: {$size: 1,$eq: authGroup}},{fields: {authGroups: 1,ownerIDs: 1}}))
            ...
            .then(function(ownerIDs) {
              ...
              if (authGroupsByownerID) self.addAuthGroupToAuthGroupsByOwnerID(authGroupsByownerID,authGroup,ownerIDs);
...
UpdateAuthGroupsAndOwnerIDs.prototype.addAuthGroupToAuthGroupsByOwnerID = function(authGroupsByownerID,authGroup,ownerIDs) {
  ...
  ownerIDs.forEach(function (ownerID) {
    if (! authGroupsByownerID[ownerID]) authGroupsByownerID[ownerID] = [];
